...
- map and station: `map.geocode`, `map.route`, `stations.nearby/list/detail/piles.list`, `piles.detail`;
- charging: `orders.create/reserve/start/active/detail/stop/settle/cancel/list`;
- administration: overview, revenue trend, pile status, user, station, and pile management under `admin.*`.
