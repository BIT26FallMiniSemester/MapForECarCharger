...
{
    setMinimumHeight(168);setMaximumHeight(184);setSizePolicy(QSizePolicy::Expanding,QSizePolicy::Fixed);setObjectName(QStringLiteral("stationMap"));m_background->setGeometry(rect());m_background->setAlignment(Qt::AlignCenter);m_background->setText(QStringLiteral("正在连接腾讯地图节点…"));m_background->setStyleSheet(QStringLiteral("background:#0b1b1e;color:#88a7a2;border:1px solid #31545a;border-radius:2px;font-family:'DejaVu Sans Mono';"));
